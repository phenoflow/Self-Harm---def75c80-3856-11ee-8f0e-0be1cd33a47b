...
steps:
  ...
  resident-self-harm---primary:
    run: resident-self-harm---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-specified---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: resident-self-harm---primary/output
  ...
  self-harm-undeterm---primary:
    run: self-harm-undeterm---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  selfharm---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-undeterm---primary/output
